...
AnimationController.States = {
  { name = "Moving", texture = "Animation_Bomb_Enemy", FramesX = 3, FramesY = 1, FramesTotal = 3, FramesPS = 9 }, 
  { name = "Held", texture = "jackbox_heldSprite1", FramesX = 1, FramesY = 1, FramesTotal = 1, FramesPS = 1 }, 
  { name = "Throw", texture = "Animation_Bomb_EnemyExploding", FramesX = 6, FramesY = 1, FramesTotal = 6, FramesPS = 10 }, 
